...
func _createCustomMetricsCredential(appId string, policyDB db.PolicyDB) error {
...
func CreateCustomMetricsCredential(appId string, policyDB db.PolicyDB, maxRetry int) error {
	...
	for {
		...
		err = _createCustomMetricsCredential(appId, policyDB)
		if err == nil {
			return nil
		}
		count++
